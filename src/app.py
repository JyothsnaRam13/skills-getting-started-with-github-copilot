...
activities = {
    ...
    "Art Workshop": {
        "description": "Creative sessions for drawing, painting, and design",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["isaac@mergington.edu", "mila@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "STEM challenges and science competition preparation",
